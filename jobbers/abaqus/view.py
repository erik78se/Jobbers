...
def ask_jobname(default_name="my-job"):
    ...
    questions = [inquirer.Text("jobname", message="Name of job", default=default_name)]
...
def ask_cpus_int():
    ...
    questions = [
        inquirer.List("cpus", message="Needed cpus", choices=[1, 2, 4, 8, 16, 32, 64])
    ]
...
def ask_gpus_bool():
    ...
    questions = [
        inquirer.Confirm("gpus", message="Should GPUs be used?", default=False)
    ]
...
def ask_nodes():
    ...
    questions = [
        inquirer.List("nodes", message="Max nodes:", choices=[1, 2, 3, 4], default=1)
    ]
...
def ask_inp():
    ...
    if not input_files:
        ...
        questions = [
            inquirer.List(
                "inpfile", message="Select input deck, *.inp file", choices=input_files
            )
        ]
...
def ask_abaqus_module():
    ...
    q = [
        inquirer.List("module", message="Select abaqus module", choices=m, default=m[0])
    ]
